...
@torch.no_grad()
def evaluation_mask_transformer(out_dir, val_loader, trans, writer, ep, best_fid, best_div,
...
@torch.no_grad()
def evaluation_mask_transformer_plus(out_dir, val_loader, trans, vq_model, writer, ep, best_fid, best_div,
                           best_top1, best_top2, best_top3, best_matching, eval_wrapper, plot_func,
                           save_ckpt=False, save_anim=False):
